...
export function parserrunnerdata_get_javascript(a: number): Array;
export function parserrunnerdata_get_html(a: number): Array;
export function parserrunnerdata_get_highlights(a: number): Array;
export function parserrunnerdata_get_imports(a: number): Array;
export function parserrunnerdata_get_triggers(a: number): Array;
...
export function __wbg_get_highlight_color(a: number): Array;
