...
mod tests_simple {
    ...
    fn test_ellipsis_6_close() {
        ...
        assert_eq!(
            linq_like_writer::write_first(&parser.data.exprs),
            "(assign@3,4,5$34$$3 \"sub\"@7 (sub@11,12,13$34$$3 (sub@15,16,17$34$$3 \
            (sub@19,20,21$34$$3 (sub@23,24,25$34$$3 (sub@27,28,29$34$$3 (litnum 1@31$$3)))))))"
        );
    }
    #[test]
    fn test_2_peirod() {
        ...
        assert_eq!(
            linq_like_writer::write_first(&parser.data.exprs),
            "(assign@3,4,5$19 \"sub\"@7 (sub@11,12,13$18 (litnum 1@15$$3)))"
        );
    }
    ...
    fn test_ellipsis_overload_12() {
        ...
        assert_eq!(
            linq_like_writer::write_first(&parser.data.exprs),
            "(assign@3,4,5$61$$3 \"sub\"@7 (sub@11,12,13$61$$3 (sub@15,16,17$58$$3 (sub@19,20,21$58$$3 (sub@23,24,25$58$$3 \
            (sub@27,28,29$58$$3 (sub@31,32,33$58$$3 (sub@35,36,37$58$$3 (sub@39,40,41$58$$3 (sub@43,44,45$58$$3 \
            (sub@47,48,49$58$$3 (sub@51,52,53$58$$3 (litnum 1@55$$3)))))))))))))"
        );
    }
